...
runImmediately
{
      ...
      trUnitChangeName("+1 Forest Fire God Power");
      trUnitSelectClear();
      trUnitSelectByID(5243216);
...
active
{
   ...
   if (tempExp)
   {
      trPlayerGrantResources(1, "Food", 25);
...
inactive
{
   if (((true) != false))
   {
      trMessageSetText("CITY ESCAPE by Waldo (V19.2) Unit Balance by MegaJunt - Advanced Triggers by Nottud", 3);
      trUnitSelectClear();
