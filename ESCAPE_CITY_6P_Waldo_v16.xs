...
runImmediately
{
      ...
      trModifyProtounitData("Guardian", 5, 14, 99, 1);
      ...
      trModifyProtounitData("Guardian", 6, 14, 99, 1);
...
inactive
{
   if (((true) != false))
   {
      trMessageSetText("CITY ESCAPE by Waldo (V16) Unit Balance by MegaJunt - Advanced Triggers by Nottud", 3);
      trUnitSelectClear();
...
active
{
   if (((kbUnitGetProtoUnitID(2360095) >= 0) != true))
   {
      ...
      trDisableTrigger(675);
      trDisableTrigger(676);
