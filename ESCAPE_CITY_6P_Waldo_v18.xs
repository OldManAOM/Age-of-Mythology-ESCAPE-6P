...
active
{
   if (((true) != false))
   {
      trCounterAddTime("U5", 1700, 0, "Hunters Unlocked Final Units! Guardians Released!", -1);
...
active
{
   ...
   if (((kbUnitTypeCountInArea("OldMan", 5, cUnitStateAlive, 262328, 6) == 1) != true) && (((xsGetTime() - (cActivationTime / 1000)) >= 30) != false))
   {
