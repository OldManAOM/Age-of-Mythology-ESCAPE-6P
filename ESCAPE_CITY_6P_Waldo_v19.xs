...
inactive
{
   if (((true) != false))
   {
      trMessageSetText("CITY ESCAPE by Waldo (V18) Unit Balance by MegaJunt - Advanced Triggers by Nottud", 3);
      trUnitSelectClear();
...
rule _Return_Shop_OldMan_P6
highFrequency
active
{
   if ((kbUnitTypeCountInArea("OldMan", 6, cUnitStateAlive, 1326911, 20.5) == 1) == false)
   {
      trUnitSelectClear();
      trUnitSelectByID(9175071);
      trUnitTeleport(371.59, 13.00, 462.14);
      trUnitSelectClear();
      trUnitSelectByID(263023);
      trUnitSetHeading(0);
      xsDisableRule("_Return_Shop_OldMan_P6");
      trDisableRule("Return_Shop_OldMan_P6");
      trDelayedRuleActivation("_Return_Shop_OldMan_P6");
   }
}

rule _Return_Shop_OldMan_P5
highFrequency
active
{
   if ((kbUnitTypeCountInArea("OldMan", 5, cUnitStateAlive, 1326911, 20.5) == 1) == false)
   {
      trUnitSelectClear();
      trUnitSelectByID(263023);
      trUnitTeleport(363.74, 13.00, 462.85);
      trUnitSelectClear();
      trUnitSelectByID(9175071);
      trUnitSetHeading(0);
      xsDisableRule("_Return_Shop_OldMan_P5");
      trDisableRule("Return_Shop_OldMan_P5");
      trDelayedRuleActivation("_Return_Shop_OldMan_P5");
   }
}

rule _Return_Shop_OldMan__P1
highFrequency
active
{
   if (((kbUnitTypeCountInArea("OldMan", 1, cUnitStateAlive, 798221, 21) == 1) != true))
   {
      trUnitSelectClear();
      trUnitSelectByID(1272);
      trUnitTeleport(250.02, 13.00, 463.62);
      trUnitSelectClear();
      trUnitSelectByID(1272);
      trUnitSetHeading(0);
      xsDisableRule("_Return_Shop_OldMan__P1");
      trDisableRule("Return_Shop_OldMan__P1");
      trDelayedRuleActivation("_Return_Shop_OldMan__P1");
   }
}

rule _Return_Shop_OldMan__P2
highFrequency
active
{
   if (((kbUnitTypeCountInArea("OldMan", 2, cUnitStateAlive, 798221, 21) == 1) != true))
   {
      trUnitSelectClear();
      trUnitSelectByID(1273);
      trUnitTeleport(252.32, 13.00, 464.00);
      trUnitSelectClear();
      trUnitSelectByID(1273);
      trUnitSetHeading(0);
      xsDisableRule("_Return_Shop_OldMan__P2");
      trDisableRule("Return_Shop_OldMan__P2");
      trDelayedRuleActivation("_Return_Shop_OldMan__P2");
   }
}

rule _Return_Shop_OldMan__P3
highFrequency
active
{
   if (((kbUnitTypeCountInArea("OldMan", 3, cUnitStateAlive, 798221, 21) == 1) != true))
   {
      trUnitSelectClear();
      trUnitSelectByID(1274);
      trUnitTeleport(254.61, 13.00, 463.71);
      trUnitSelectClear();
      trUnitSelectByID(1274);
      trUnitSetHeading(0);
      xsDisableRule("_Return_Shop_OldMan__P3");
      trDisableRule("Return_Shop_OldMan__P3");
      trDelayedRuleActivation("_Return_Shop_OldMan__P3");
   }
}

rule _Return_Shop_OldMan__P4
highFrequency
active
{
   if (((kbUnitTypeCountInArea("OldMan", 4, cUnitStateAlive, 798221, 21) == 1) != true))
   {
      trUnitSelectClear();
      trUnitSelectByID(1275);
      trUnitTeleport(257.13, 13.00, 463.79);
      trUnitSelectClear();
      trUnitSelectByID(1275);
      trUnitSetHeading(0);
      xsDisableRule("_Return_Shop_OldMan__P4");
      trDisableRule("Return_Shop_OldMan__P4");
      trDelayedRuleActivation("_Return_Shop_OldMan__P4");
   }
}
