...
active
{
   ...
   if (tempExp)
   {
      trArmyDispatch("5,24", "Colossus", 2, 346.97, 4.00, 366.28, 0, true, false);
...
active
{
   ...
   if (tempExp)
   {
      trArmyDispatch("5,26", "Guardian", 2, 346.79, 4.00, 366.39, 0, true, false);
...
active
{
   ...
   if (tempExp)
   {
      trPlayerGrantResources(1, "Food", 35);
      trPlayerGrantResources(2, "Food", 35);
      trPlayerGrantResources(3, "Food", 35);
      trPlayerGrantResources(4, "Food", 35);
...
inactive
{
   if (((true) != false))
   {
      trMessageSetText("CITY ESCAPE by Waldo (V12) Unit Balance by MegaJunt - Advanced Triggers by Nottud", 3);
      trUnitSelectClear();
...
active
{
   ...
   {
      for(int PlayerX6 = 5; PlayerX6 <= 6; PlayerX6 = PlayerX6 + 1){
      trDamageUnitsInArea(PlayerX6,"StymphalianBird",30,1000);
      trDamageUnitsInArea(,"",,);
      trDamageUnitsInArea(,"",,);
      trDamageUnitsInArea(,"",,);
      trDamageUnitsInArea(,"",,);
